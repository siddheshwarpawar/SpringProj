...
//		res = new FileSystemResource("src/com/sp/cfgs/applicationContext.xml");
		...
		// invoke method
		System.out.println("WishMessage ::"+wg.genrateWishMessage("Siddhu"));
